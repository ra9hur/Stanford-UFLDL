...
save('SAEFeatures.mat', 'trainFeatures', 'testFeatures');
...
% trainLabels
% trainFeatures = load("trainFeatures.txt");
% testFeatures = load("testFeatures.txt");
...
%
% Actual
%   minFunc softmaxTrain = 96.23%
%   fminlbfgs softmaxTrain = 96.28%
